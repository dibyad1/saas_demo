- dashboard: saas_pulse
  ...
  - title: Current ARR
    ...
    note_display: below
    note_text: Annual Recurring Revenue
    listen: {}
    row: 3
    col: 15
    width: 6
  ...
  - title: Current Customers
    ...
    note_state: collapsed
    note_display: below
    note_text: Active Parent Accounts
    listen: {}
    row: 7
    col: 15
    width: 6
  ...
  - name: Pulse Metrics
    ...
    subtitle_text: Company Performance Indicators
    row: 0
    col: 0
    width: 24
    height: 3
  ...
  - name: " (2)"
    ...
    width: 2
    height: 7
  - title: Biggest Wins This Quarter
    name: Biggest Wins This Quarter
    model: sfdc_demo
    explore: opportunity_line_item
    type: looker_grid
    ...
    width: 10
    height: 7
  - title: New Opportunities Generated this Quarter
    name: New Opportunities Generated this Quarter
    model: sfdc_demo
    explore: opportunity_line_item
    type: looker_column
  ...
  - title: New ARR
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    comparison_label: Quarter License Goal
    x_axis_gridlines: false
    ...
    width: 7
    height: 4
  - title: Cumulative New ARR this Quarter
    name: Cumulative New ARR this Quarter
    model: sfdc_demo
    explore: company_goals
    type: looker_line
    ...
    filters:
      opportunity.time_period_filter: quarter
      opportunity.opportunity_closed_in_period: Prior Period
    ...
    width: 10
    height: 6
  - title: Cumulative NRR this Quarter
    name: Cumulative NRR this Quarter
    model: sfdc_demo
    explore: company_goals
    type: looker_line
    ...
    width: 10
    height: 6
  - title: Team Tracking to Goal
    name: Team Tracking to Goal
    model: sfdc_demo
    explore: company_goals
    type: looker_column
    ...
    width: 10
    height: 7
  - title: New Logos This Quarter (by ACV)
    name: New Logos This Quarter (by ACV)
    model: sfdc_demo
    explore: opportunity_line_item
    ...
    width: 10
    height: 6
  - title: Year over Year Retention
    name: Year over Year Retention
    model: sfdc_demo
  ...
  - title: "$BNR"
    ...
    note_state: collapsed
    note_display: hover
    note_text: Net Revenue Retention is calculated by taking the total active ARR,
      subtracting ARR from customers who's first contract started in the past 365
      days, and comparing that to the active ARR one year ago
    listen: {}
    row: 3
    col: 10
    width: 5
    height: 4
  - title: Total Product Usage Time
    name: Total Product Usage Time
    model: sfdc_demo
  ...
  - title: Events by Type
    ...
    fill_fields: [daily_user_count.event_date]
    filters:
      daily_user_count.event_date: last quarter
    sorts: [daily_user_count.event_date]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
